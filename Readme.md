...
Enlace a Drive: [https://drive.google.com/drive/folders/1HqBG2-sUkz_R3h1dZU5F2uAzpRn7BSpj](^13^).
...
## Modelo de Machine Learning: Sistema de Recomendación
 ...
 El desarrollo del mismo está basado en similitud de género utilizando TF-IDF (Term Frequency-Inverse Document Frequency) y similitud del coseno para recomendar juegos. Se vectoriza el texto de la columna "géneros" utilizando TF-IDF, lo que permite representar cada juego como un vector numérico basado en los géneros. Posteriormente, se calcula la similitud del coseno entre el juego consultado y el resto de los juegos, y se seleccionan los 5 juegos más similares para recomendar, excluyendo el juego original.
